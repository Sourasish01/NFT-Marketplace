      ...
      <div className="flex min-h-screen w-full items-center justify-center text-lg text-white">
        {isLoggingIn ? (
          ...
          >
            ...
            <form onSubmit={handleSubmit} className='flex flex-wrap md:flex-nowrap space-y-6 md:space-y-0 md:space-x-8'>
              {/* Image Upload Section */}
              <div className="w-full md:w-1/2 p-4 border border-gray-600 rounded-md shadow-sm flex flex-col items-center justify-center text-sm font-medium text-gray-300 min-h-[250px]">
                <input
                  type="file"
                  id="image"
                  className="sr-only"
                ...
                {formData.image && !imagePreview && (
                  <span className="mt-2 text-sm text-gray-400">Image uploaded</span>
                )}
              </div>
